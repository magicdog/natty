...
import com.hipu.date.ANTLRNoCaseInputStream;
import com.hipu.date.ParseListener;
...
public abstract class AbstractGrammarTest {
  ...
  protected String buildAST(String value) throws Exception {
    ...
    Class<?> klass = Class.forName("com.hipu.date.generated.DateParser");
