...
//    validateDateTime("April 20 at 10 am", 4, 20, 2012, 10, 0, 0);
  ...
  public void testRelative() throws Exception {
    ...
    validateDateTime("seven years ago at 3pm", 5, 19, 2005, 15, 0, 0);
...
//    validateDateTime("tomorrow 11:20", 2, 25, 2011, 19, 0, 0);
...
//    validateDateTime("tomorrow @ noon", 2, 25, 2011, 12, 0, 0);
    //shelton
    //12 am == 0  12 pm == 24
    validateDateTime("1 hour ago", 5, 18, 2012, 23, 0, 0);
    validateDateTime("April 8, 2013", 4, 8, 2013, 0, 0, 0);
//    validateDateTime("june 6, 2012 UPDATER BYU  ASF  GF 2012-4-5", 6, 6, 2012, 16, 31, 0);
